  ...
  return (
    <>
      <div className={inter.className}>
        ...
        <CustomDialog open={profileOpen} onClose={closeProfile} title="User Profile">
          <UserProfile />
        </CustomDialog>

        <CustomDialog open={changePasswordOpen} onClose={closeChangePassword} title="Change Password">
          <ChangePassword />
        </CustomDialog>
      </div>
      <Footer />
